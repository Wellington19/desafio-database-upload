...
Continuação backend Node.js com TypeScript, utilizando o conceito de models, repositories e services, mas dessa vez incluindo o uso de banco de dados postgres com o TypeORM e envio de arquivos com o Multer.

Essa será uma aplicação que deve armazenar transações financeiras de entrada e saída e permitir o cadastro e a listagem dessas transações, além de permitir a criação de novos registros no banco de dados a partir do envio de um arquivo csv, seguindo os requisitos propostos logo abaixo pelo desafio 6 do bootcamp GoStack da Rocketseat.
...
<h4 align="center">
  ⚠️ Antes de executar a aplicação você precisa ter o postgres rodando e um banco de dados com o nome "gostack_desafio06" para funcionar corretamente, olhar arquivo de configuração "ormconfig.json" ⚠️
</h4>

Para rodar a aplicação execute o comando `yarn dev:server` ou `npm run dev:server`
